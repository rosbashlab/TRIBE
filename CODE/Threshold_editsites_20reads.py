...
Command line:  nice nohup python Threshold_RNA04_out_AM.py [input_file1] [input_file2] [input_file3] [etc] &

Removes 'edited sites' below threshold
1) remove entries <10 reads  (column 8 - Total)
2) remove entries < 0.05 edited (edit/total) (column 14/column 15) (editbasecount/Total)
